 ...
 */
final class Version20210412181245 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE answer (id INT NOT NULL, question_id_id INT NOT NULL, user_id_id INT NOT NULL, content TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, likes INT NOT NULL, dislikes INT NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE "user" (id INT NOT NULL, login VARCHAR(64) NOT NULL, password VARCHAR(128) NOT NULL, email VARCHAR(255) NOT NULL, telnumber VARCHAR(9) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE TABLE user_details (id INT NOT NULL, user_id_id INT NOT NULL, role BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, description TEXT DEFAULT NULL, likes INT NOT NULL, dislikes INT NOT NULL, PRIMARY KEY(id))');
